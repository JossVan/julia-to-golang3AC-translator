...
_lr_productions = [
  ...
  ('INICIO -> R_PAQUETES R_MAIN PTCOMA IMPORTES PILA_HEAP PILA_STACK DECLARACIONES FUNCIONES','INICIO',8,'p_inicio','optimizacion.py',170),
  ('IMPORTES -> R_IMPORT PARIZQ LISTAIMPORTES PARDER PTCOMA','IMPORTES',5,'p_paquetitos','optimizacion.py',173),
  ('LISTAIMPORTES -> LISTAIMPORTES PTCOMA CADENA','LISTAIMPORTES',3,'p_listaimportes2','optimizacion.py',176),
  ('LISTAIMPORTES -> CADENA','LISTAIMPORTES',1,'p_listaimporte2','optimizacion.py',181),
  ('PILA_HEAP -> R_VAR ID CORIZQ ENTERO CORDER R_FLOAT PTCOMA','PILA_HEAP',7,'p_pilastack','optimizacion.py',184),
  ('PILA_STACK -> R_VAR ID CORIZQ ENTERO CORDER R_FLOAT PTCOMA','PILA_STACK',7,'p_pilaheap','optimizacion.py',187),
  ('DECLARACIONES -> DECLARACIONES DECLARACION','DECLARACIONES',2,'p_declaraciones','optimizacion.py',190),
  ('DECLARACIONES -> DECLARACION','DECLARACIONES',1,'p_declaraciones2','optimizacion.py',195),
  ('DECLARACION -> R_VAR LISTAS R_FLOAT PTCOMA','DECLARACION',4,'p_declaracion','optimizacion.py',198),
  ('LISTAS -> LISTAS COMA LISTA','LISTAS',3,'p_listas','optimizacion.py',201),
  ('LISTAS -> LISTA','LISTAS',1,'p_listas2','optimizacion.py',206),
  ('LISTA -> ID','LISTA',1,'p_lista','optimizacion.py',209),
  ('FUNCIONES -> FUNCIONES FUNCION','FUNCIONES',2,'p_funciones','optimizacion.py',212),
  ('FUNCIONES -> FUNCION','FUNCIONES',1,'p_funciones2','optimizacion.py',217),
  ('FUNCION -> R_FUNCION ID PARIZQ PARDER LLAVEIZQ INSTRUCCIONES LLAVEDER','FUNCION',7,'p_funcion','optimizacion.py',221),
  ('FUNCION -> R_FUNCION R_MAIN PARIZQ PARDER LLAVEIZQ INSTRUCCIONES LLAVEDER','FUNCION',7,'p_funcion','optimizacion.py',222),
  ('INSTRUCCIONES -> INSTRUCCIONES INSTRUCCION','INSTRUCCIONES',2,'p_instrucciones','optimizacion.py',225),
  ('INSTRUCCIONES -> INSTRUCCION','INSTRUCCIONES',1,'p_instrucciones2','optimizacion.py',230),
  ('INSTRUCCION -> ASIGNACION','INSTRUCCION',1,'p_instruccion2','optimizacion.py',233),
  ('INSTRUCCION -> PRINTS','INSTRUCCION',1,'p_instruccion2','optimizacion.py',234),
  ('INSTRUCCION -> ETIQUETAS','INSTRUCCION',1,'p_instruccion2','optimizacion.py',235),
  ('INSTRUCCION -> SALTOS','INSTRUCCION',1,'p_instruccion2','optimizacion.py',236),
  ('INSTRUCCION -> LLAMADAS','INSTRUCCION',1,'p_instruccion2','optimizacion.py',237),
  ('INSTRUCCION -> IFS','INSTRUCCION',1,'p_instruccion2','optimizacion.py',238),
  ('INSTRUCCION -> RETURN','INSTRUCCION',1,'p_instruccion2','optimizacion.py',239),
  ('RETURN -> R_RETURN PTCOMA','RETURN',2,'p_return','optimizacion.py',242),
  ('PRINTS -> R_FMT PUNTO R_PRINTF PARIZQ CADENA COMA E PARDER PTCOMA','PRINTS',9,'p_println','optimizacion.py',245),
  ('PRINTS -> R_FMT PUNTO R_PRINTF PARIZQ CADENA COMA R_INT PARIZQ E PARDER PARDER PTCOMA','PRINTS',12,'p_println2','optimizacion.py',248),
  ('ETIQUETAS -> ID DOSPUNTITOS','ETIQUETAS',2,'p_etiquetas','optimizacion.py',251),
  ('SALTOS -> R_GOTO ID PTCOMA','SALTOS',3,'p_saltos','optimizacion.py',254),
  ('ASIGNACION -> ID IGUAL E PTCOMA','ASIGNACION',4,'p_asignacion','optimizacion.py',257),
  ('ASIGNACION -> ARREGLOS IGUAL E PTCOMA','ASIGNACION',4,'p_asignacion','optimizacion.py',258),
  ('E -> E MAS E','E',3,'p_expresiones','optimizacion.py',261),
  ('E -> E MENOS E','E',3,'p_expresiones','optimizacion.py',262),
  ('E -> E POR E','E',3,'p_expresiones','optimizacion.py',263),
  ('E -> E DIVIDIDO E','E',3,'p_expresiones','optimizacion.py',264),
  ('E -> PARIZQ E PARDER','E',3,'p_expresion_parentesis','optimizacion.py',274),
  ('E -> R_MATH PUNTO R_MOD PARIZQ E COMA E PARDER','E',8,'p_expresion_modal','optimizacion.py',277),
  ('E -> MENOS E','E',2,'p_expresion_unaria','optimizacion.py',280),
  ('E -> ID','E',1,'p_constantes','optimizacion.py',283),
  ('E -> DECIMAL','E',1,'p_constantes2','optimizacion.py',286),
  ('E -> ENTERO','E',1,'p_constentes3','optimizacion.py',289),
  ('E -> ARREGLOS','E',1,'p_constantes4','optimizacion.py',292),
  ('IFS -> R_IF RE LLAVEIZQ SALTOS LLAVEDER','IFS',5,'p_ifs','optimizacion.py',295),
  ('RE -> RE MENQUE RE','RE',3,'p_relacionales','optimizacion.py',298),
  ('RE -> RE MAYQUE RE','RE',3,'p_relacionales','optimizacion.py',299),
  ('RE -> RE IGUALQUE RE','RE',3,'p_relacionales','optimizacion.py',300),
  ('RE -> RE NIGUALQUE RE','RE',3,'p_relacionales','optimizacion.py',301),
  ('RE -> RE MENORIGUAL RE','RE',3,'p_relacionales','optimizacion.py',302),
  ('RE -> RE MAYORIGUAL RE','RE',3,'p_relacionales','optimizacion.py',303),
  ('RE -> PARIZQ RE PARDER','RE',3,'p_relacionales2','optimizacion.py',320),
  ('RE -> E','RE',1,'p_relacioneales3','optimizacion.py',323),
  ('LLAMADAS -> ID PARIZQ PARDER PTCOMA','LLAMADAS',4,'p_llamaditas','optimizacion.py',326),
  ('ARREGLOS -> ID CORIZQ E CORDER','ARREGLOS',4,'p_arreglos','optimizacion.py',329),
  ('ARREGLOS -> ID CORIZQ R_INT PARIZQ E PARDER CORDER','ARREGLOS',7,'p_arreglos2','optimizacion.py',332),
]
